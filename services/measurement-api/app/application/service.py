...
from analytics.classification.classifier import classify_file
from analytics.common.io import read_csv, write_csv, write_json
from analytics.metrics.calculator import MetricsCalculator
from analytics.simulation.generator import generate_files


class MeasurementService:
    def __init__(self, root: Path) -> None:
        self.root = root
        self.original = root / "data/original/incidentes_2025.csv"
        self.processed = root / "data/processed"
        self.simulated = root / "data/simulated"
        self.evidence = root / "evidencias/resultados"
        self.survey_log = root / "data/simulated/patient_surveys.csv"
