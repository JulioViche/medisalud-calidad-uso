...
class _SurveyPageState extends State<SurveyPage> {
  ...
  Widget build(BuildContext context) => PatientScaffold(title: 'Encuesta', child: ListView(padding: const EdgeInsets.all(18), children: [
        ...
        const Text('Las respuestas alimentan las metricas ISO/IEC 25022.', style: TextStyle(fontSize: 12)),
        ...
        if (sent) const Padding(padding: EdgeInsets.only(bottom: 12), child: Text('Respuesta registrada como evidencia simulada.', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFF0C695F)))),
