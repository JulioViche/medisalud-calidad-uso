...
\begin{itemize}
  \item Los escenarios 1--8 se desarrollan a partir del material docente suministrado. Los escenarios 9--12 se reconstruyen desde el índice disponible y se identifican como tales.
