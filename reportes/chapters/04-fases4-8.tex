...
M-RIE-01 & Errores de facturación & Libertad de riesgo & porcentaje & $\leq1$ \\
M-SAT-01 & Abandono de encuesta móvil & Satisfacción & porcentaje & $\leq10$ \\
...
M-CC-02 & Caídas de teleconsulta & Cobertura del contexto & porcentaje & $\leq5$ \\
\bottomrule
\end{longtable}
...
\begin{table}[H]
\centering
\caption{Resultados consolidados del ciclo 13--14 de julio de 2026}
...
\midrule
\textbf{Total consolidado} & \textbf{50/50} & \textbf{36 casos actuales y 14 casos vigentes del ciclo integral previo.} \\
\bottomrule
\end{tabularx}
\end{table}
...
\evidence{El pipeline produjo diez métricas y la suite analítica ampliada aprobó 36 de 36 casos. El catálogo consolidado suma 50 de 50 casos con las demás suites del ciclo integral.}
