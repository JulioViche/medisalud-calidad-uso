...
\scenario{9}{Construcción y visualización de indicadores · reconstrucción declarada}
...
M-RIE-01 & Errores de facturación & Libertad de riesgo & 4,50\% & $<1$\% & \statusred \\
M-SAT-01 & Abandono de encuesta móvil & Satisfacción & 9,80\% & $<10$\% & \statusgreen \\
...
M-CC-02 & Caídas de teleconsulta & Cobertura del contexto & 8,68\% & $<5$\% & \statusyellow \\
\bottomrule
\end{longtable}
...
\scenario{10}{Interpretación y causa raíz · reconstrucción declarada}
...
\scenario{11}{Comunicación para dirección · reconstrucción declarada}
...
\scenario{12}{Ciclo PDCA sin modificar la línea base · reconstrucción declarada}
