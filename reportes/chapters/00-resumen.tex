...
El procedimiento integró los doce escenarios del taller en cinco momentos: comprensión del caso y del modelo SQuaRE; clasificación de incidentes; diseño de atributos y métricas; automatización, visualización e interpretación; y formulación del ciclo de mejora. La verificación práctica ejecutó 19 casos automatizados de seis suites y aprobó los 19, junto con las construcciones React y Flutter y una carga JMeter de 500 solicitudes sin errores.
