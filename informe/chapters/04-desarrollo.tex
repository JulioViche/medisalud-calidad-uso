...
ISO/IEC 25000 organiza la familia SQuaRE; ISO/IEC 25010 define modelos de calidad; ISO/IEC 25022 establece medidas de calidad en uso; e ISO/IEC 25040 orienta el proceso de evaluación \cite{iso25010,iso25022,iso25040}.

\begin{figure}[H]
\centering
\includegraphics[width=.76\textwidth]{figures/square.png}
...
Calidad en uso & Tiempo real que tarda un médico en registrar una nota clínica durante consulta externa. \\
\bottomrule
\end{tabularx}
\end{table}

Estos ejemplos diferencian el objeto de evaluación. SonarQube observa propiedades internas del código; JMeter observa el comportamiento externo bajo carga; e ISO/IEC 25022 permite estudiar el resultado experimentado por el usuario. Un sistema puede tener código limpio y aun así ofrecer tiempos o flujos deficientes. Por ello SonarQube no resuelve, por sí solo, la lentitud percibida por los médicos. SonarQube y JMeter se emplean aquí como ejemplos conceptuales solicitados por el taller; no se presentan como herramientas ejecutadas en esta entrega.
